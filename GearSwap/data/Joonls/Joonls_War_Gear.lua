function user_job_setup()
	...
	state.Weapons:options('Chango','ShiningOne', 'Naegling')
...
function init_gear_sets()
	...
	sets.idle = {
		ammo="Ginsen",
		head="Flam. Zucchetto +2",
		body={ name="Valorous Mail", augments={'Accuracy+16','"Dbl.Atk."+2','AGI+5','Attack+2',}},
		hands="Sulev. Gauntlets +2",
		legs={ name="Valorous Hose", augments={'Attack+22','"Store TP"+6','DEX+4','Accuracy+12',}},
		...
		back={ name="Mauler's Mantle", augments={'DEX+1','STR+2','Accuracy+3','Crit. hit damage +3%',}},
	}
...
-- Ragnarok melee sets
	...
	sets.weapons.ShiningOne = {main="Shining One"}
