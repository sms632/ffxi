...
function user_job_setup()
	...
	state.Weapons:options('Terp', 'Tauret','TPBonus','PunchTime')
	...
	gear.wsd_jse_back = { name="Senuna's Mantle", augments={'DEX+10','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons = {}
	sets.weapons.Terp = {main="Terpsichore", sub="Fusetto +2"}
	sets.weapons.Tauret = {main="Tauret", sub="Ternion Dagger +1"}
	sets.weapons.TPBonus = {main="Tauret", sub="Fusetto +2"}
	...
	sets.engaged.Acc = {
		...
		head={ name="Adhemar Bonnet", augments={'DEX+10','AGI+10','Accuracy+15',}},
		body={ name="Herculean Vest", augments={'"Snapshot"+4','DEX+6','Quadruple Attack +3','Accuracy+16 Attack+16','Mag. Acc.+16 "Mag.Atk.Bns."+16',}},
		hands={ name="Herculean Gloves", augments={'Attack+26','"Triple Atk."+4',}},
		legs="Meg. Chausses +2",
		feet={ name="Herculean Boots", augments={'Accuracy+30','"Triple Atk."+3','AGI+4','Attack+1',}},
		neck="Clotharius Torque",
		waist={ name="Sailfi Belt +1", augments={'Path: A',}},
    ...
    sets.buff['Climactic Flourish'] = {ammo="Charis Feather", body="Meg. Cuirie +2"} --head="Charis Tiara +2"
