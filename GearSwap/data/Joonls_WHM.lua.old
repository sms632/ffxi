...
function init_gear_sets()
    ...
    --  /SCH --3
        ...
        back={ name="Mending Cape", augments={'Healing magic skill +6','Enha.mag. skill +10',}}, --10
        waist="Embla Sash", --5
        }
    ...
    sets.midcast.Cursna = set_combine(sets.midcast.StatusRemoval, {
        ...
        back={ name="Mending Cape", augments={'Healing magic skill +6','Enha.mag. skill +10',}}, --25
        waist="Bishop's Sash",
        })
