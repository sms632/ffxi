...
function init_gear_sets()
    ...
    body={ name="Herculean Vest", augments={'Accuracy+27','"Triple Atk."+3','DEX+6','Attack+10',}},
    hands="Meg. Gloves +2",
    legs={ name="Herculean Trousers", augments={'Weapon skill damage +4%','Pet: Attack+19 Pet: Rng.Atk.+19','Accuracy+13 Attack+13','Mag. Acc.+19 "Mag.Atk.Bns."+19',}},
    feet={ name="Herculean Boots", augments={'Accuracy+11','"Triple Atk."+3','DEX+6','Attack+14',}},
    neck="Fotia Gorget",
    waist="Fotia Belt",
    ...
    sets.engaged = {    main={ name="Aettir", augments={'Accuracy+70','Mag. Evasion+50','Weapon skill damage +10%',}},
    sub="Utu Grip",
    ammo="Falcon Eye",
    head={ name="Herculean Helm", augments={'Rng.Acc.+18','"Triple Atk."+2','DEX+9','Accuracy+11','Attack+15',}},
    body={ name="Herculean Vest", augments={'Accuracy+27','"Triple Atk."+3','DEX+6','Attack+10',}},
    hands={ name="Adhemar Wrist. +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
    legs={ name="Herculean Trousers", augments={'Accuracy+13','"Triple Atk."+3','STR+9','Attack+5',}},
    feet={ name="Herculean Boots", augments={'Accuracy+11','"Triple Atk."+3','DEX+6','Attack+14',}},
