...
function init_gear_sets()
    ...
    back={ name="Rudianos's Mantle", augments={'HP+60','Accuracy+20 Attack+20','HP+16','Enmity+10','Phys. dmg. taken-10%',}},}
    ...
    sets.precast.FC.DT = {    ammo="Ginsen",
    head={ name="Souv. Schaller +1", augments={'HP+105','Enmity+9','Potency of "Cure" effect received +15%',}},
    body="Rev. Surcoat +2",
    hands={ name="Leyline Gloves", augments={'Accuracy+14','Mag. Acc.+13','"Mag.Atk.Bns."+13','"Fast Cast"+2',}},
    legs={ name="Souv. Diechlings +1", augments={'HP+105','Enmity+9','Potency of "Cure" effect received +15%',}},
	...
	sets.DayIdle = {legs="Carmine Cuisses +1"}
	sets.NightIdle = {legs="Carmine Cuisses +1"}
