...
function job_setup()
    ...
    blue_magic_maps.Magical = S{
        ...
        'Retinal Glare','Subduction','Tem. Upheaval','Water Bomb', 'Spectral Floe', 'Anvil Lightning', 
		'Tenebral Crush', 'Blinding Fulgor',
    }
...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'Refresh', 'Learning', 'Turtle')
...
function init_gear_sets()
	...
	sets.precast.WS['Expiacion'] = {
	    ammo="Ginsen",
		head={ name="Herculean Helm", augments={'Accuracy+17 Attack+17','"Triple Atk."+3','Accuracy+2','Attack+9',}}, --replace
		body="Ayanmo Corazza +2", --replace
		hands="Jhakri Cuffs +2",
		legs={ name="Samnuha Tights", augments={'STR+9','DEX+8','"Dbl.Atk."+2','"Triple Atk."+2',}}, --replcae
		feet={ name="Herculean Boots", augments={'Accuracy+30','"Triple Atk."+3','AGI+4','Attack+1',}}, --replace
		neck="Fotia Gorget",
		waist="Fotia Belt",
		left_ear={ name="Moonshade Earring", augments={'Attack+4','TP Bonus +250',}},
		right_ear="Ishvara Earring",
		left_ring="Petrov Ring", --replace
		right_ring="Rajas Ring", --replace
		back={ name="Rosmerta's Cape", augments={'STR+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}},
	}
	...
	sets.midcast['Blue Magic']['Subduction'] = set_combine(sets.midcast['Blue Magic'].MagicAccuracy,
		{
			head="Wh. Rarab Cap +1",
			legs={ name="Herculean Trousers", augments={'Enmity+1','"Blood Pact" ability delay -2','"Treasure Hunter"+1',}},
			feet={ name="Herculean Boots", augments={'AGI+1','Attack+14','"Treasure Hunter"+1','Accuracy+15 Attack+15',}},
	...
	sets.midcast['Blue Magic']['Glutinous Dart'] = set_combine(sets.midcast['Blue Magic'].MagicAccuracy,
		{
			legs={ name="Herculean Trousers", augments={'Enmity+1','"Blood Pact" ability delay -2','"Treasure Hunter"+1',}},
			feet={ name="Herculean Boots", augments={'AGI+1','Attack+14','"Treasure Hunter"+1','Accuracy+15 Attack+15',}},
			waist="Chaac Belt",
