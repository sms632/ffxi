...
function init_gear_sets()
    ...
    sets.precast.WS['Wildfire'] = {
		...
		body={ name="Herculean Vest", augments={'"Mag.Atk.Bns."+19','Pet: Attack+7 Pet: Rng.Atk.+7','Accuracy+20 Attack+20','Mag. Acc.+17 "Mag.Atk.Bns."+17',}},
    ...
    sets.precast.WS['Savage Blade'] = {    
		...
		body={ name="Herculean Vest", augments={'"Mag.Atk.Bns."+17','Weapon skill damage +4%','INT+9','Mag. Acc.+2',}},
		hands="Meg. Gloves +2",
